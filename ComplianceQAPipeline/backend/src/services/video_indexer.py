...
class VideoIndexer:
    ...
    def get_account_token(self, arm_access_token):
        '''
        Excahnges the ARM for Video Indexer account team
        '''
        url = (
    ...
    def download_youtube_video(self, url, output_path = "temp_video.mp4"):
        ...
        try:
            ...
            raise Exception(f"Youtube video dwonload failed : {str(e)}")
    ...
    def wait_for_processing(self, video_id):
        ...
        while True:
            ...
            if state == "Processed":
                ...
                raise Exception("Video Quarantined (CopyRight / Content Policy Violoation)")
